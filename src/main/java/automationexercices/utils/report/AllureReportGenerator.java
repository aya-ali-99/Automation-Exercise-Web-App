...
import automationexercices.utils.OSUtils;
import automationexercices.utils.TerminalUtils;
...
import static automationexercices.utils.report.AllureConstants.HISTORY_FOLDER;
import static automationexercices.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        automationexercices.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
