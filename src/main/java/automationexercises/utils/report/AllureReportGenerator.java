package automationexercises.utils.report;

import automationexercises.utils.OSUtils;
import automationexercises.utils.TerminalUtils;
...
import static automationexercises.utils.dataReader.PropertyReader.getProperty;
import static automationexercises.utils.report.AllureConstants.HISTORY_FOLDER;
import static automationexercises.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        automationexercises.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
